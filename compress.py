...
input_dir = '/content/pillow-compress-lossless/pictures' # directory containing the images to be compressed
output_dir = '/content/pillow-compress-lossless/output_images' # directory where the compressed images will be saved
